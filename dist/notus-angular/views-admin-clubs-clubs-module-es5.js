  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-admin-clubs-clubs-module"], {
        ...
        return _createClass(InsertFamilyComponent, [{
          ...
          value: function guardar() {
            ...
            if (this.edicion === true) {
              ...
              var family2 = new src_app_model_Family__WEBPACK_IMPORTED_MODULE_10__["Family"]();
              ...
              this.familyService.insertFamiliar(family).subscribe(function () {
                ...
                _this13.familyService.mensajeCambio.next('Primer familiar agregado satisfactoriamente');

                _this13.infoSnackBar.open('Primer familiar agregado', '', {
                  duration: 2000
                }).afterDismissed().subscribe(function () {
                  _this13.familyService.insertFamiliar(family2).subscribe(function () {
                    _this13.form.reset();

                    _this13.dialogRef.close();

                    _this13.familyService.mensajeCambio.next('Segundo familiar agregado satisfactoriamente');

                    _this13.infoSnackBar.open('Segundo familiar agregado', '', {
                      duration: 2000
                    });
                  }, function (error) {
                    _this13.infoSnackBar.open(error, '', {
    ...
    function mZFD(module, __webpack_exports__, __webpack_require__) {
      ...
      var InsertAthleteComponent = /*#__PURE__*/function () {
        ...
        return _createClass(InsertAthleteComponent, [{
          ...
          key: "listarCiudades",
          value: function listarCiudades(id) {
            var _this23 = this;

            this.generalService.getCitiesId(id).subscribe(function (data) {
              _this23.cities = data;
            });
          }
        }, {
          ...
          value: function guardar() {
            ...
            if (this.edicion === true) {
              ...
              this.athleteService.editAthlete(athlete).subscribe(function () {
                ...
                _this25.router.navigate(["/admin/clubs/".concat(_this25.id, "/athlete")]);
              }, function (error) {
    ...
    function zEXN(module, __webpack_exports__, __webpack_require__) {
      ...
      var AthleteComponent = /*#__PURE__*/function () {
        function AthleteComponent(route, router, athleteService, dialog, snackBar, clubService) {
        ...
        return _createClass(AthleteComponent, [{
          ...
          value: function listarPaginado() {
            ...
            this.clubService.getAthletesByClub(this.id).subscribe(function (data) {
              _this30.dataSourceAthleteExcel = new _angular_material_table__WEBPACK_IMPORTED_MODULE_8__["MatTableDataSource"](data);
            });
          }
        }, {
          key: "cambiarPagina",
          ...
          key: "exportExcel",
          value: function exportExcel() {
            var dataToExport = this.dataSourceAthleteExcel.data.map(function (row) {
              var acudientes = row.familyDtoList.reduce(function (acc, familiar, index) {
                acc["Relacion acudiente ".concat(index + 1)] = familiar.relationship;
                acc["Nombre acudiente ".concat(index + 1)] = familiar.name;
                acc["Documento acudiente ".concat(index + 1)] = familiar.document;
                acc["Tipo Documento acudiente ".concat(index + 1)] = familiar.documentType.description;
                acc["Telefono acudiente ".concat(index + 1)] = familiar.phone;
                acc["Correo acudiente ".concat(index + 1)] = familiar.email;
                acc["Empresa acudiente ".concat(index + 1)] = familiar.company;
                acc["Ocupacion acudiente ".concat(index + 1)] = familiar.occupation;
                return acc;
