(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! C:\Users\nicko\Documents\Trabajo\Meraki\meraki_front\src\main.ts */
      "zUnb");
      /***/
    },
    ...
    function Qvvb(module, __webpack_exports__, __webpack_require__) {
      ...
      var GeneralService = /*#__PURE__*/function () {
        ...
        return _createClass(GeneralService, [{
          ...
          key: "getCitiesId",
          value: function getCitiesId(id) {
            return this.http.get("".concat(this.url, "/getCities/").concat(id));
          }
        }, {
          key: "getDocuments",
    ...
    function RMzx(module, __webpack_exports__, __webpack_require__) {
      ...
      var LandingComponent = /*#__PURE__*/function () {
        ...
        return _createClass(LandingComponent, [{
          ...
          key: "reloadBack",
          value: function reloadBack() {
            var _this2 = this;

            this.generalService.getCitiesSports(this.generalService.idSport).subscribe(function (data) {
              _this2.cities = data;
              _this2.selectSport.value = _this2.generalService.idSport;

              if (_this2.generalService.idCity) {
                var selectedChip = _this2.cities.find(function (city) {
                  return city.id === _this2.generalService.idCity;
                });
            ...
            if (this.generalService.idSport) {
              ...
              this.clubService.getPageFilterSportAndCity(this.pageIndex, this.pageSize, this.generalService.idSport, this.generalService.idCity).subscribe(function (data) {
                _this2.clubs = data.content; // Actualizar el número de páginas

                _this2.clubService.getNumClubs(_this2.generalService.idSport, _this2.generalService.idCity).subscribe(function (data) {
                  _this2.pages = Math.ceil(data / 1);
                });
              });
            }
          }
        ...
        return _createClass(InsertImageComponent, [{
          ...
          value: function listar() {
            ...
            this.imageClubService.getImages(this.idClub).subscribe(function (data) {
              _this5.dataSourceImages = new _angular_material_table__WEBPACK_IMPORTED_MODULE_7__["MatTableDataSource"](data);
            });
          }
        }, {
          key: "inicializarFormularioVacio",
          ...
          value: function saveFile() {
            ...
            if (this.selectedFile) {
              this.imageClubService.insertImageClub(clubImage, this.selectedFile).subscribe(function () {
                _this7.infoSnackBar.open('Imagen guardada satisfactoreamente', 'Informacion', {
                  duration: 2000
                });

                _this7.listar();

                _this7.selectedFile = undefined;
                _this7.imgURL = null;
          ...
          value: function _delete(url, id) {
            ...
            this.imageClubService.deleteImageClub(url, id).subscribe(function () {
              _this8.infoSnackBar.open('Imagen eliminada satisfactoreamente', 'Informacion', {
                duration: 2000
              });
        ...
        return _createClass(ClubComponent, [{
          ...
          value: function guardar() {
            ...
            this.clubService.editClub(club).subscribe(function () {
              _this11.openSnackBar('Club editado satisfactoreamente');

              _this11.router.navigate(['/admin/club']);
            }, function (error) {
              _this11.infoSnackBar.open(error, '', {
                duration: 2000
              });
            });
          }
                ...
                while (1) switch (_context3.prev = _context3.next) {
                  ...
                  case 2:
                    ...
                    this.clubService.getClub(this.id).subscribe(function (data) {
                      ...
                      _this12.form.get("description").setValue(data.description);

                      _this12.sport = data.sport;
                      _this12.city = data.city;
                      _this12.nombreDeporte = data.sport.name;
                      _this12.nombreCiudad = data.city.nombre;

                      _this12.form.get("instragramLink").setValue(data.instragramLink);

                      _this12.form.get("facebookLink").setValue(data.facebookLink);

                      _this12.form.get("twitterLink").setValue(data.twitterLink);

                      _this12.form.get("tiktokLink").setValue(data.tiktokLink);

                      _this12.form.get("youtubeLink").setValue(data.youtubeLink);

                      _this12.form.get("whatsappLink").setValue(data.whatsappLink);
                    });
    ...
    function Zhdy(module, __webpack_exports__, __webpack_require__) {
      ...
      var ClubService = /*#__PURE__*/function () {
        ...
        return _createClass(ClubService, [{
          ...
          value: function getAthletesByClub(club) {
            return this.http.get("".concat(this.url, "/getAllExcel/").concat(club));
          }
        }, {
          key: "getClub",
    ...
    function os1z(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfileComponent = /*#__PURE__*/function () {
        function ProfileComponent(route, router, clubService, imagesService, viewportScroller, generalService) {
        ...
        return _createClass(ProfileComponent, [{
          ...
          value: function getClub(id) {
            ...
            this.clubService.getClub(id).subscribe(function (data) {
              ...
              _this14.imagesService.getImages(data.id).subscribe(function (data) {
                _this14.images = data;
              });
            });
          }
